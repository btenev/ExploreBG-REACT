...
import { useDeleteComment } from '../../../hooks/dataHooks/useDeleteComment';
import { useGetEntityComments } from '../../../hooks/dataHooks/useGetEntityComments';
  ...
  const handleNewComment = (newComment: IComment) => {
    setComments((prevComments) => {
      ...
      if (index !== -1) {
        ...
        return [...prevComments.slice(0, index), newComment, ...prevComments.slice(index + 1)];
      }
