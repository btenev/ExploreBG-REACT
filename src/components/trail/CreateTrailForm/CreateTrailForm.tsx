      ...
      >
        ...
        <div className="form-container__form__pair">
          ...
          <div>
            ...
            {errors.elevationGained && (
              <div className="error-message">
                {errors.elevationGained.message}
              </div>
            )}
          </div>
        </div>
        <div className="form-container__form__pair">
          ...
          <div className="form-container__form__pair__checkbox">
            ...
            {errors.activity && (
              <div className="error-message">{errors.activity.message}</div>
            )}
          </div>
        </div>
        <div className="form-container__form__pair">
        ...
        {!dataForReview && (
          <p style={{ color: "black" }}>
            * You can add photos after create this trail.
          </p>
        )}
        ...
        {(!dataForReview || (dataForReview && !forReview)) &&
          dataForReview?.detailsStatus !== StatusEnum.approved && (
            <SubmitButton
              ...
              buttonName={
                dataForReview && !forReview ? "Approve" : "Create trail"
              }
            />
          )}
      </form>
